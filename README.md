...
| 38 | 🟠 **7.5** | `go-square` · Go (Celestia) | Reachable panic / denial-of-service via an exported parsing API — availability-only, downstream / public-API scope (details embargoed until fixed) `CWE-129` · CVSS v4.0 8.7 High | [GHSA-fg3q-p289-h9rr](https://github.com/celestiaorg/go-square/security/advisories/GHSA-fg3q-p289-h9rr) | 🔄 pending |

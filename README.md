...
| 34 | 🟡 **6.9** | `shiny` (py-shiny) · pip | py-shiny ≤ 1.6.3: unauth bookmark path traversal `CWE-22` | [GHSA-47c3-hpmg-7j6p](https://github.com/posit-dev/py-shiny/security/advisories/GHSA-47c3-hpmg-7j6p) | 🔄 published |
...
| 58 | 🟡 **5.3** | `@fastify/static` · npm | Route-guard / `allowedPath` bypass via path case-fold on a case-insensitive FS (Windows / macOS) — incomplete-fix residual of CVE-2026-18427 `CWE-178` | [GHSA-r799-r9gc-m956](https://github.com/fastify/fastify-static/security/advisories/GHSA-r799-r9gc-m956) | ✅ [CVE-2026-90982](https://nvd.nist.gov/vuln/detail/CVE-2026-90982) |
